...
<h2>GNINA Docking Results (MYC–Ligand Complex)</h2>
...
<pre>from IPython.display import HTML
import py3Dmol
...
<p>This code visualizes the docked MYC–ligand (10058-F4) complex using the Py3Dmol library in an interactive 3D viewer.
It first loads the MYC protein structure from the AlphaFold PDB file and stores it for visualization.
Then, it reads the docking output file (SDF) generated by GNINA, which contains the ligand binding poses.
The protein is displayed in a cartoon representation with a spectrum color scheme, while the ligand is shown in stick form.
Finally, both structures are combined in a single 3D view, allowing visualization of ligand binding within the MYC protein pocket.</p>
<img width="949" height="564" alt="image" src="https://github.com/user-attachments/assets/a7375310-827f-49cb-97c4-efc7a73b294a" />
<p>For 3D visualization Click this link</p>
https://colab.research.google.com/drive/1q-KWXehftshvs-PxKH6U2TFFzaTLMI5G#scrollTo=B240kaaqEJQ0&fullscreenOutput=true
<div class="box">
